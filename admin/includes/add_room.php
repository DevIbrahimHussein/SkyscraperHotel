...
$query = "INSERT INTO Rooms(RoomName, Type, Description, View, Floor, NbOfBeds, SizeOfBeds, Price, ImageID, HotelID)";
$query .=" VALUES('{$room_name}', '{$room_type}', '{$room_description}', '{$room_view}',{$room_floor}, {$room_bed_number}, '{$room_bed_size}', {$room_price}, {$room_images}, {$room_hotel})";

$create_room = mysqli_query($connection, $query);

confirmQuery($create_room);
...
<div class="form-group">
  ...
  <div class="form-group">
    <input type="submit" name="create_room" value="Publish Room" class="btn btn-primary">
  </div>
